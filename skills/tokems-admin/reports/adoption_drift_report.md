...
- `2026-08-17T14:30:00+08:00` `tokems-admin` event=`script_run` source=`yao_cli` command=`pnpm-test-tokems-admin-skill` activation=`unknown` outcome=`accepted` failure=`none`
