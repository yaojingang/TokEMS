...
- Pending/invalid answers hidden: `10`
- Reviewer checklist: `0` ready / `10` total
...
| template-patch-live-revision | pending | hidden | pending |  |  |
| attendee-needs-governance | pending | hidden | pending |  |  |
| feishu-digest-read-boundary | pending | hidden | pending |  |  |
...
| `template-patch-live-revision` | `awaiting-decision` | `hidden` | `/Users/laoyao/AI Coding/01-Projects/Active/TokEMS/skills/tokems-admin/reports/output_review_decisions.json` |
| `attendee-needs-governance` | `awaiting-decision` | `hidden` | `/Users/laoyao/AI Coding/01-Projects/Active/TokEMS/skills/tokems-admin/reports/output_review_decisions.json` |
| `feishu-digest-read-boundary` | `awaiting-decision` | `hidden` | `/Users/laoyao/AI Coding/01-Projects/Active/TokEMS/skills/tokems-admin/reports/output_review_decisions.json` |
